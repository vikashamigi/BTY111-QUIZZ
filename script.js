...
const quiz = [
  ...
  { q:"73. Micropropagation is used for:", o:["Mutation","Rapid multiplication","Hybridization","Fertilization"], a:1 },
  { q:"74. Vector in genetic engineering is used to:", o:["Cut DNA","Carry gene","Destroy DNA","Sequence DNA"], a:1 },
  { q:"75. Taq polymerase is obtained from:", o:["E. coli","Virus","Thermus aquaticus","Yeast"], a:2 },
  { q:"76. Transgenic organisms contain:", o:["Same genes","Mutated genes","Foreign genes","Deleted genes"], a:2 },
  { q:"77. Biofertilizers improve:", o:["Pollution","Soil fertility","Toxicity","Acidity"], a:1 },
  { q:"78. Bio pesticides are:", o:["Harmful","Synthetic","Eco-friendly","Radioactive"], a:2 },
  { q:"79. Recombinant insulin is produced using:", o:["Virus","Yeast","Bacteria","All of the above"], a:3 },
  { q:"80. ELISA is used for:", o:["DNA cutting","Disease diagnosis","Cloning","Fermentation"], a:1 },
  { q:"81. Antibiotics work against:", o:["Virus","Bacteria","Cancer","Allergy"], a:1 },
  { q:"82. BLAST is used for:", o:["Cutting DNA","Sequence comparison","PCR","Translation"], a:1 },
  { q:"83. Proteomics studies:", o:["Genes","RNA","Proteins","Lipids"], a:2 },
  { q:"84. Genome refers to:", o:["Single gene","RNA","Complete DNA","Protein"], a:2 },
  { q:"85. GMO release requires:", o:["Approval","Ban","No control","Mutation"], a:0 },
  { q:"86. Intellectual property protects:", o:["Ideas","Innovations","Data only","Microbes"], a:1 },
  { q:"87. Patent gives:", o:["Ownership","Copying rights","Public access","Free use"], a:0 },
  { q:"88. Biosafety levels range from:", o:["1–4","1–2","2–5","3–6"], a:0 },
  { q:"89. Sewage treatment uses:", o:["Viruses","Algae","Bacteria","Plants"], a:2 },
  { q:"90. Activated sludge contains:", o:["Dead cells","Living microbes","Chemicals","Plastics"], a:1 },
  { q:"91. Composting is:", o:["Chemical process","Biological process","Physical process","Nuclear process"], a:1 },
  { q:"92. Waste to energy is an example of:", o:["Medical biotech","Industrial biotech","Environmental biotech","Agricultural biotech"], a:2 },
  { q:"93. Biofuel example is:", o:["Petrol","Diesel","Ethanol","Kerosene"], a:2 },
  { q:"94. Vaccine works by providing:", o:["Nutrition","Immunity","Energy","Treatment"], a:1 },
  { q:"95. Monoclonal antibodies are produced by:", o:["Bacteria","Hybridoma","Virus","Plants"], a:1 },
  { q:"96. Insulin is used to treat:", o:["Cancer","Diabetes","Tuberculosis","Asthma"], a:1 },
  { q:"97. Gene therapy is an example of:", o:["Environmental biotech","Medical biotech","Industrial biotech","Agricultural biotech"], a:1 },
  { q:"98. Biotechnology is multidisciplinary because it involves:", o:["Biology only","Technology only","Biology and technology","Chemistry only"], a:2 },
  { q:"99. Bioinformatics helps in:", o:["Drug discovery","Data analysis","Sequence alignment","All of the above"], a:3 },
  { q:"100. Biotechnology has maximum importance in:", o:["Past","Present","Future","None"], a:2 }
];
